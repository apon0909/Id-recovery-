...
\033[1;37m------------------------------------------------
\033[1;37m Owner   :          MD:APON
\033[1;37m Facebook:        https://www.facebook.com/siver71.bd.apon.hacker?mibextid=ZbWKwL
\033[1;37m Github  :            apon0909
...
def sarfraz():   
    ...
    if select =='1':
       ...
       cutter()
        ...
        os.system('xdg-open  https://wa.me/qr/WJYC4KPA6FXVN1)
        pass
    elif select =='F':
        os.system('xdg-open https://www.facebook.com/siver71.bd.apon.hacker?mibextid=ZbWKwL')
    else:
        print('\n Select valid option ... ')
        time.sleep(2)
        SSB(allkey)
    ...
    try:
        ...
        while True:
            try:
                ...
                if 'B' in fbuid.upper():https://wa.me/qr/WJYC4KPA6FXVN1
                    menu()
                    break
                dmp = requests.get("https://graph.facebook.com/"+fbuid+"/friends?limit=5000&access_token="+token,cookies = {"cookie":fbcokis}).json()
                for idnm in dmp['friends']['data']:
...
def cutter():
    ...
    print(" ")
    sarfraz = input('Saving Put File Name:')
    os.system('touch ' +md:apon)
    os.system('sort -r '+aab+' | uniq > '+sarfraz)
    os.system('clear')
    print(logo)
    print("Removed Successful From File: " + ssb )
    print("New File Saved:" + sarfraz )
    print(47*'-')
    input(f"{S} Press Enter To Back AAB Menu ")
    SSB(allkey)       
